...
namespace Data
{
    ...
    public class CharacterData : CollectableData
    {
        ...
        public static readonly EStateEffectProperty[] INT_PROPERTIES = new EStateEffectProperty[] {
            ...
            EStateEffectProperty.Power,
            EStateEffectProperty.Haste,
            EStateEffectProperty.Resistance,
            ...
            EStateEffectProperty.DotDamage,
            EStateEffectProperty.DotHeal,
            EStateEffectProperty.DotShield,
            EStateEffectProperty.DotEnergy,
        };
        ...
        public static bool CheckIsInt(string property)
        {
            ...
            return INT_PROPERTIES.Any(t => property.EndsWith(t.ToString()));
        }
        ...
        public static bool CheckIsPercentageValue(string property)
        {
            return property.EndsWith("Perc")
                ...
                || property.Contains(EStateEffectProperty.AttackSpeed.ToString())
                || property.Contains(EStateEffectProperty.CastSpeed.ToString())
                || property.Contains(EStateEffectProperty.LifeSteal.ToString())
                || property.Contains(EStateEffectProperty.SpeedBonus.ToString())
                || property.Contains(EStateEffectProperty.Lethality.ToString())
        ...
        public override Dictionary<string, object> GetInfo()
        {
            ...
            foreach (SCharacterStatScaling data in CharacterStatScaling)
            {
                ...
                infosDict.Add(data.GetKeyName(), CheckIsInt(data.StateEffectProperty.ToString()) ? Math.Round(data.GetValue(m_Level)) : data.GetValue(m_Level));
            }
